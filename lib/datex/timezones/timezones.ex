defmodule Datex.Timezones do


	def timezones do
		[
		  {"Africa/Abidjan", "UTC/GMT"},
		  {"Africa/Accra", "UTC/GMT"},
		  {"Africa/Addis_Ababa", "UTC/GMT +03:00"},
		  {"Africa/Algiers", "UTC/GMT +01:00"},
		  {"Africa/Asmera", "UTC/GMT +03:00"},
		  {"Africa/Bamako", "UTC/GMT"},
		  {"Africa/Bangui", "UTC/GMT +01:00"},
		  {"Africa/Banjul", "UTC/GMT"},
		  {"Africa/Bissau", "UTC/GMT"},
		  {"Africa/Blantyre", "UTC/GMT +02:00"},
		  {"Africa/Brazzaville", "UTC/GMT +01:00"},
		  {"Africa/Bujumbura", "UTC/GMT +02:00"},
		  {"Africa/Cairo", "UTC/GMT +03:00"},
		  {"Africa/Casablanca", "UTC/GMT"},
		  {"Africa/Conakry", "UTC/GMT"},
		  {"Africa/Dakar", "UTC/GMT"},
		  {"Africa/Dar_es_Salaam", "UTC/GMT +03:00"},
		  {"Africa/Djibouti", "UTC/GMT +03:00"},
		  {"Africa/El_Aaiun", "UTC/GMT"},
		  {"Africa/Freetown", "UTC/GMT"},
		  ...
		  {"America/Araguaina", "UTC/GMT -03:00"},
		  ...
		  {"America/Asuncion", "UTC/GMT -04:00"},
		  ...
		  {"America/Campo_Grande", "UTC/GMT -04:00"},
		  ...
		  {"America/Indianapolis", "UTC/GMT -04:00"},
		  ...
		  {"America/Montevideo", "UTC/GMT -03:00"},
		  ...
		  {"America/Port-au-Prince", "UTC/GMT -05:00"},
		  ...
		  {"America/Sao_Paulo", "UTC/GMT -03:00"},
		  ...
		  {"Asia/Tehran", "UTC/GMT +04:30"},
		  {"Asia/Thimphu", "UTC/GMT +06:00"},
		  {"Asia/Tokyo", "UTC/GMT +09:00"},
		  {"Asia/Ujung_Pandang", "UTC/GMT +08:00"},
		  ...
		  {"Asia/Yerevan", "UTC/GMT +05:00"},
		  {"Atlantic/Azores", "UTC/GMT"},
		  {"Atlantic/Bermuda", "UTC/GMT -03:00"},
		  {"Atlantic/Canary", "UTC/GMT +01:00"},
		  {"Atlantic/Cape_Verde", "UTC/GMT -01:00"},
		  {"Atlantic/Faeroe", "UTC/GMT +01:00"},
		  {"Atlantic/Madeira", "UTC/GMT +01:00"},
		  {"Atlantic/Reykjavik", "UTC/GMT"},
		  {"Atlantic/South_Georgia", "UTC/GMT -02:00"},
		  {"Atlantic/Stanley", "UTC/GMT -03:00"},
		  {"Atlantic/St_Helena", "UTC/GMT"},
		  {"Australia/Canberra", "UTC/GMT +10:00"},
		  {"Australia/North", "UTC/GMT +09:30"},
		  {"Australia/NSW", "UTC/GMT +10:00"},
		  {"Australia/Queensland", "UTC/GMT +10:00"},
		  {"Australia/South", "UTC/GMT +09:30"},
		  {"Australia/Tasmania", "UTC/GMT +10:00"},
		  {"Australia/Victoria", "UTC/GMT +10:00"},
		  {"Australia/West", "UTC/GMT +08:00"},
		  {"Chile/Continental", "UTC/GMT -04:00"},
		  ...
		  {"Pacific/Auckland", "UTC/GMT +12:00"},
		  {"Pacific/Chatham", "UTC/GMT +12:45"},
		  {"Pacific/Efate", "UTC/GMT +11:00"},
		  {"Pacific/Enderbury", "UTC/GMT +13:00"},
		  {"Pacific/Fakaofo", "UTC/GMT -10:00"},
		  {"Pacific/Fiji", "UTC/GMT +12:00"},
		  ...
		  {"Pacific/Ponape", "UTC/GMT +11:00"},
		  {"Pacific/Port_Moresby", "UTC/GMT +10:00"},
		  {"Pacific/Rarotonga", "UTC/GMT -10:00"},
		  {"Pacific/Saipan", "UTC/GMT +10:00"},
		  {"Pacific/Samoa", "UTC/GMT -11:00"},
		  {"Pacific/Tahiti", "UTC/GMT -10:00"},
		  {"Pacific/Tarawa", "UTC/GMT +12:00"},
		  {"Pacific/Tongatapu", "UTC/GMT +13:00"},
		  {"Pacific/Truk", "UTC/GMT +10:00"},
		  {"Pacific/Wallis", "UTC/GMT +12:00"},
		  {"Pacific/Yap", "UTC/GMT +10:00"},
		  {"US/Samoa", "UTC/GMT -11:00"}
		]
	end

	@doc false
	def get_seconds_from_timezone(zone_name) do
		[{_key, offset}] = 
			Enum.filter(timezones(), fn ({key, _value}) -> key == zone_name end) 
		seconds = 
			case String.split(offset, " ") do
				[_utc, diff] ->
					[hours, minute] = String.split(diff, ":")
					min = String.to_integer(minute)
					{hour, _} = Integer.parse(hours)
					cond do
						hour >= 0 ->
							hour * 3600 + (min/60) * 3600
						true ->
							hour * 3600 - (min/60) * 3600
					end
				[_any] ->
